...
void Matrix_4f::InitScaleTransform(float ScaleX, float ScaleY, float ScaleZ)
{
...
//void Matrix_4f::InitRotateTransform(float RotateX, float RotateY, float RotateZ)
//{
//    Matrix_4f rx, ry, rz;
//
...
void Matrix_4f::InitTranslationTransform(float x, float y, float z)
{
...
void Matrix_4f::InitCameraTransform(const Vec3f& Target, const Vec3f& Up)
{
    Vec3f N = Target;
    N.normalize();
    Vec3f U = Up;
...
//void Matrix_4f::InitPersProjTransform(const PersProjInfo& p)
//{
...
float Matrix_4f::Determinant() const
{
